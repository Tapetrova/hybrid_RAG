...
class LLMParameters(BaseModelUpd):
    """LLM Parameters model."""
    ...
    model: LLMModel | str = Field(
        description="The LLM model to use.", default=defs.LLM_MODEL
    )
...
class LLMParametersReduced(BaseModelUpd):
    """LLM Parameters model."""
