...
from ...prompts.graphrag.entity_extraction.entity_extraction_prompt import (
...
class EntityExtractionConfig(LLMConfig):
    ...
    def resolved_strategy(self, root_dir: str, encoding_model: str) -> dict:
        ...
        from apps.knowledge_manager.src.graphrag.index.verbs.entities.extraction import (
