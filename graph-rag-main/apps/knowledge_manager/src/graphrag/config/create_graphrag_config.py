...
from libs.python.schemas.graphrag import LLMConfig
from libs.python.schemas.graphrag.global_search_config import (
    ContextBuilderParams,
)
from libs.python.schemas.graphrag.llm_parameters import LLMParametersReduced
    ...
    with reader.envvar_prefix(Section.graphrag), reader.use(values):
        ...
        with (
            ...
            global_search_model = GlobalSearchConfig(
                ...
                max_data_tokens=reader.int("data_max_tokens")
                ...
                reduce_llm_params=LLMParametersReduced(
                    top_p=reader.float(Fragment.top_p) or defs.LLM_TOP_P,
                    n=reader.int(Fragment.n) or defs.LLM_N,
                    max_tokens=reader.int("reduce_max_tokens")
