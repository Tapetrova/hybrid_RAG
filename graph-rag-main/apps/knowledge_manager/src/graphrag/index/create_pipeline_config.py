...
from apps.knowledge_manager.src.graphrag.config.models import (
    GraphRagConfig,
    TextEmbeddingConfig,
)
...
from apps.knowledge_manager.src.graphrag.index.config.input import (
    PipelineCSVInputConfig,
    PipelineInputConfigTypes,
    PipelineTextInputConfig,
)
from apps.knowledge_manager.src.graphrag.index.config.pipeline import (
    PipelineConfig,
)
from apps.knowledge_manager.src.graphrag.index.config.reporting import (
...
from apps.knowledge_manager.src.graphrag.index.config.workflow import (
    PipelineWorkflowReference,
)
from apps.knowledge_manager.src.graphrag.index.workflows.default_workflows import (
    ...
    match file_type:
        case InputFileType.csv:
            return PipelineCSVInputConfig(
                ...
                file_filter=settings.input.file_filter,
...
def _get_cache_config(
    ...
    match settings.cache.type:
        ...
        case CacheType.redis:
            base_name = settings.cache.base_name
            return PipelineRedisCacheConfig(
                base_name=base_name,
            )
        case _:
            # relative to root dir
