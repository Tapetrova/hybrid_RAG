...
from apps.knowledge_manager.src.graphrag.query.question_gen.base import (
    BaseQuestionGen,
    QuestionResult,
)
from libs.python.prompts.graphrag.question_gen.system_prompt import (
...
class LocalQuestionGen(BaseQuestionGen):
    ...
    async def agenerate(
        ...
        **kwargs,
        ...
        if context_data is None:
            ...
            context_data, context_records = await self.context_builder.build_context(
                query=question_text,
    ...
    def generate(
        ...
        **kwargs,
        ...
        if context_data is None:
            # generate context data based on the question history
            context_data, context_records = asyncio.run(
