...
from apps.knowledge_manager.src.graphrag.query.context_builder.community_context import (
...
from apps.knowledge_manager.src.graphrag.query.context_builder.local_context import (
    build_covariates_context,
    build_entity_context,
    build_relationship_context,
    get_candidate_context,
)
from apps.knowledge_manager.src.graphrag.query.input.retrieval.community_reports import (
...
class LocalSearchMixedContext(LocalContextBuilder):
    ...
    async def build_context(
        ...
        **kwargs: dict[str, Any],
        ...
        if conversation_history:
            ...
            ) = await conversation_history.build_context(
    ...
    def _build_community_context(
        ...
        if len(selected_entities) == 0 or len(community_reports) == 0:
        ...
        selected_communities = [
            ...
            if community_id in community_reports
        ]
