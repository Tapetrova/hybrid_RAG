...
from apps.knowledge_manager.src.graphrag.query.llm.oai.typing import OpenaiApiType
...
def get_global_search_engine(
    ...
    return GlobalSearch(
        ...
        token_encoder=token_encoder,
        max_data_tokens=gs_config.max_data_tokens,
        map_llm_params={
            "max_tokens": gs_config.map_llm_params.max_tokens,
            "temperature": gs_config.map_llm_params.temperature,
            "top_p": gs_config.map_llm_params.top_p,
            "n": gs_config.map_llm_params.n,
        },
        reduce_llm_params={
            "max_tokens": gs_config.reduce_llm_params.max_tokens,
            "temperature": gs_config.reduce_llm_params.temperature,
            "top_p": gs_config.reduce_llm_params.top_p,
            "n": gs_config.reduce_llm_params.n,
        },
        ...
        context_builder_params={
            ...
            "max_tokens": gs_config.context_builder_params.max_tokens,
