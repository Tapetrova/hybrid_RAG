...
class AsyncChromiumLoader(BaseLoader):
    """Scrape HTML pages from URLs using a headless instance of Chromium."""
    ...
    async def ascrape_playwright(self, url: str) -> str:
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                logger.info(f"Content scraped successfully for URL: {url}")
    ...
    async def aload(self) -> List[Document]:
        """Asynchronously load and return all Documents from the provided URLs.
