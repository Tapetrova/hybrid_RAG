...
# 1. Question Category Distribution (Pie Chart)
categories = {}
for q in questions:
...
colors = ['#ff9800', '#4CAF50', '#2196F3', '#9C27B0']  # Orange, Green, Blue, Purple
...
plt.tight_layout()
plt.savefig('/Users/tapetrova/PycharmProjects/Car_paper_v2/pythonProject/dataset_creation/analysis/chart1_category_distribution.png', 
            dpi=300, bbox_inches='tight')
plt.show()
print("Created chart1_category_distribution.png")
...
print("\nAll three charts have been created successfully!")
print("Files saved:")
print("1. chart1_category_distribution.png")
print("2. chart2_question_length.png")  
print("3. chart3_answer_length.png")